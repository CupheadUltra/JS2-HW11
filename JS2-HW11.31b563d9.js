...
})({"h3raS":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 62857;
...
let interval = setInterval(()=>{
    ...
    if (minutesLeft === 30) message.textContent = "\u0417\u0430\u043B\u0438\u0448\u0438\u043B\u043E\u0441\u044C \u043C\u0435\u043D\u0448\u0435 \u043F\u043E\u043B\u043E\u0432\u0438\u043D\u0438 \u0447\u0430\u0441\u0443!";
    if (minutesLeft <= 0) {
...
let startTimer = ()=>{
    ...
    let frame = ()=>{
        ...
        if (timeLeft <= 10000) timerDisplay.classList.add("animate");
        if (timeLeft > 0) animationId = requestAnimationFrame(frame);
        else {
...
},{}]},["h3raS","a0t4e"], "a0t4e", "parcelRequire52c9", {})

//# sourceMappingURL=JS2-HW11.31b563d9.js.map
